...
* 13TokyoAge.csv: 東京都遺跡地図【時代】列の入力項目を01ベクトルに変換したもの、JASID +自治体コード+遺跡番号+ふりがな+遺跡名+位置座標+時代別01ベクトル（Pa: 旧石器、Jo: 縄文、Ya: 弥生、Ko: 古墳、Na: 奈良、He: 平安、（An: 古代=Na+He）、Me: 中世（鎌倉〜安土桃山）、EM: 近世（江戸）、Md: 近代（明治以降）、Pr: 現代、Un: 時代不明）  
